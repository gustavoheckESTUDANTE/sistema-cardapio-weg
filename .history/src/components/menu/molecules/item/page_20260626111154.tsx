...
export default async function Item({ product }: ItemProps) {
    ...
    return <>
        <div className="p-4 flex justify-center w-full border-2 border-gray-500 rounded-3xl">
            <div className="w-full flex gap-5">
                <div className="w-20 h-20 relative overflow-hidden border-gray-500 rounded-3xl">
